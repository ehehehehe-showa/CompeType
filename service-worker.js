...
const CORE_ASSETS = [
    ...
    './questions/sentences-en-1.json',
    './questions/sentences-ja-1.json',
    './questions/words-en-basic.json',
    './questions/words-en-tech.json',
    './questions/words-ja-hiragana.json',
    './questions/words-ja-kanji.json',
    './questions/words-ja-katakana.json',
    './icons/icon-192.png',
    './icons/icon-512.png'
];
